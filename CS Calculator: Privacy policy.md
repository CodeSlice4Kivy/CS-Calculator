Privacy policy
Welcome to the app made with with kivyfor Android!

This is an open source Android app developed by CodeSlice. The source code is available on GitHub under the MIT license; the app is also available on Google Play.
